...
class AnalisisrisikoPieChartNonKlinis extends ChartWidget
{
    protected static ?string $heading = 'Distribusi Risiko Non Klinis';
      ...
      protected function getData(): array
    {
        ...
        if ($user->hasRole('superadmin')) {
            ...
            $risiko = Risk::where('tipe_risiko', 'non-klinis')->get();
            ...
            $risiko = Risk::where('tipe_risiko', 'non-klinis')
        ...
        foreach ($labels as $label) {
            $data[]   = $peringkatRisiko[$label] ?? 0; // default 0 kalau tidak ada
